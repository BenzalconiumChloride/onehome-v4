  ...
  return (
    ...
    >
      ...
      <View style={styles.inputGroupHalf}>
        <Text style={styles.label}>Type of Service Provider</Text>
        <Picker
          selectedValue={form.serviceProvider}
          style={styles.picker}
          onValueChange={(itemValue) =>
            setForm({ ...form, serviceProvider: itemValue })
          }
        >
      ...
      <View style={styles.row} className="mb-5 mt-5">
        <View style={styles.inputGroupHalf}>
